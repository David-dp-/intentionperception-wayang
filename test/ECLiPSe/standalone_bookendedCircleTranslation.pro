...
% This replicates what the test would get from circle15mm_translation_bookended.swf if it were run embedded
%  in the Java portion of the Wayang framework.
%
...
:- compile('test_bookendedCircleTranslation.pro').